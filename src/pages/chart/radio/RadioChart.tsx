...
import { getCategories, getOrdersByCategory } from '../../../assets/functions/api'
import { ICategory, IOrderByCategory, IOrders, IRadioChartData } from '../../../interfaces/Interfaces'
...
export async function loader(){
  ...
  await Promise.all(categories.map(async(c) => {
    const totalOrdersByCategory:IOrderByCategory[] = await getOrdersByCategory(c.id,token)
    if(totalOrdersByCategory === null) throw { message: 'Could not fetch events' }
